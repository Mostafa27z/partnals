<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight" data-aos="fade-down">
    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8" dir="rtl">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700" data-aos="fade-up" data-aos-delay="100">
            @if ($logs->count())
                    ...
                    <table class="min-w-full text-sm text-gray-800 dark:text-gray-200">
                        <thead class="bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 sticky top-0 z-10">
                            <tr class="text-right">
                                ...
                                <th class="px-5 py-3 border-b dark:border-gray-700 font-semibold text-red-700 dark:text-red-400">{{ __('messages.Old Value') }}</th>
                                <th class="px-5 py-3 border-b dark:border-gray-700 font-semibold text-green-700 dark:text-green-400">{{ __('messages.New Value') }}</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($logs as $log)
                                <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-200 transform hover:scale-[1.01]" 
                                    data-aos="fade-up" 
                                    ...
                                    <td class="px-5 py-3 text-red-600 dark:text-red-400 font-medium">{{ $log->old_value }}</td>
                                    <td class="px-5 py-3 text-green-600 dark:text-green-400 font-medium">{{ $log->new_value }}</td>
