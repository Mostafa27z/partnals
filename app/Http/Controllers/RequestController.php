...
class RequestController extends Controller
{
    ...
    public function storeStop(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب الإيقاف النهائي بنجاح.');
    }
    ...
    public function storeChangeDate(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب تغيير التاريخ بنجاح.');
    }
    ...
    public function storeResell(HttpRequest $request)
    {
        $validated = $request->validate([
            ...
            'new_serial'   => 'nullable|required_if:resell_type,chip|regex:/^\d+$/|size:19',
    ...
    public function storeChangePlan(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب تغيير النظام بنجاح.');
    }
    ...
    public function storeChangeChip(HttpRequest $request)
    {
        $validated = $request->validate([
            ...
            'old_serial'   => 'nullable|regex:/^\d+$/|size:19',
            'new_serial'   => 'nullable|required_if:change_type,chip|regex:/^\d+$/|size:19',
            'request_date' => 'required|date',
            'comment'      => 'nullable|string|max:1000',
            'full_name'    => 'required|string|max:255',
            'national_id'  => 'required|digits:14',
        ...
        return back()->with('success', '✅ تم إنشاء طلب تغيير الشريحة بنجاح.');
    }
    ...
    public function storePause(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب الإيقاف المؤقت بنجاح.');
    }
    ...
    public function storeResume(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب التشغيل بنجاح.');
    }

    public function createChangeDistributor(Line $line)
    {
        $distributors = \App\Models\User::whereHas('role', function ($query) {
    ...
    public function storeChangeDistributor(HttpRequest $request)
    {
        ...
        return back()->with('success', '✅ تم إنشاء طلب تغيير الموزع بنجاح.');
    }
